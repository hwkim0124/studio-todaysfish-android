package com.reelingsoft.todaysfish.rendering
...
class BackgroundRenderer {
    ...
    fun draw(
        ...
        when (cameraToDisplayRotation) {
            90 -> texCoordTransformed = floatArrayOf(1 - u, 1 - v, u, 1 - v, 1 - u, v, u, v)
            180 -> texCoordTransformed = floatArrayOf(1 - u, v, 1 - u, 1 - v, u, v, u, 1 - v)
            270 -> texCoordTransformed = floatArrayOf(u, v, 1 - u, v, u, 1 - v, 1 - u, 1 - v)
            0 -> texCoordTransformed = floatArrayOf(u, 1 - v, u, v, 1 - u, 1 - v, 1 - u, v)
