...
class PlaneRenderer {
    ...
    inner class SortablePlane internal constructor(val distance: Float, val plane: Plane)

    fun getNearestPlane(allPlanes: Collection<Plane>, cameraPose: Pose): SortablePlane? {
